...
import btcqrcode from './btcqrcode.jpg';
import ethqrcode from './ethqrcode.jpg';
import solqrcode from './solqrcode.jpg';
import dogeqrcode from './dogeqrcode.jpg';
import trxqrcode from './trxqrcode.jpg';
import usdcqrcode from './usdcqrcode.jpg';
import xrpqrcode from './xrpqrcode.jpg';
import bnbqrcode from './bnbqrcode.jpg';
import usdtqrcode from './usdtqrcode.jpg';
...
export const depositCoins = [
  {
    name: 'Bitcoin',
    network: 'BTC',
    qrcode: btcqrcode,
    address: '39UEWTFd9kjst5XR33UdWVZYaMmRoQaG9c',
  },
  {
    name: 'Ethereum',
    network: 'ERC20',
    qrcode: ethqrcode,
    address: '0x33fbf4e2e8930d76cd006d79acb864e22bb2fd5c',
  },
  {
    name: 'USDC',
    network: 'ERC20',
  ...
  },
  {
    ...
    network: 'TRC20',
    qrcode: trxqrcode,
    address: 'TBiYs3fgEX9XrVjtPu3io6E45gN5uWJTaN',
  },
  {
    name: 'Binancecoin',
    network: 'BEP-20',
    qrcode: bnbqrcode,
    address: '0xbb39f87bb676f8a9840572427604eb8499fe6521',
  },
  {
    name: 'Dogecoin',
    network: 'DOGE',
    qrcode: dogeqrcode,
    address: 'DJeeCvcjb3uuBaiPTerdnEU1i3qQKhN38T',
  },
  {
    name: 'USDT',
    network: 'ERC20',
    qrcode: usdtqrcode,
    address: '0x744d563947d9e5f77751199990d20df3b951f518',
  },
  {
    name: 'Ripple',
    network: 'XRP',
  ...
  },
  {
    ...
    network: 'SOL',
    qrcode: solqrcode,
    address: 'CrA62HA44cKsWU8KYnvNFGqt5AS2qaBw9RwGxHFJ6GHK',
  },
]

export const withdrawalCoins = [
  {
    name: 'Bitcoin',
    network: [
      {
...
export const reviewSlides = [
  ...
  },
  {
    title: 'Chike',
    group: 'Affiliate',
    text: 'Working with WeHodler is great and I am sure that we can keep doing business for many more years. Payments are always on time, Support is super helpful and answers within 1-5 hours',
    width: '100%',
    height: '100%',
    stars: 5
  },
  {
    title: 'Corey Bayless',
    group: 'Affiliate',
    text: 'Good day. I am Corey. I am quite happy with the Wehodler affiliate program as it is available to everyone.',
    width: '100%',
    height: '100%',
    stars: 4
  },
  {
    title: 'Vadin',
    group: 'Affiliate',
    text: "I've been working with Youhodler Affiliate program since late February 2021. Their support is really great and helpful, true professionals.What is important for me, their offers are truly legit and legitimate. They provide real service to their clients",
    width: '100%',
    height: '100%',
    stars: 5
  },
  {
    title: 'Joe',
    group: 'Affiliate',
    text: 'Payments are always made precisely. They have an excellent and precise dashboard with a responsive and professional manager.',
    width: '100%',
    height: '100%',
    stars: 4
  }
